...
namespace assessment_platform_developer
{
	...
	public class Global : HttpApplication
	{
		...
		private static void Bootstrap()
		{
			...
			container.Register<ICustomerRepositoryCmd, CustomerRepositoryCmd>(Lifestyle.Singleton);
            container.Register<ICustomerRepositoryQry, CustomerRepositoryQry>(Lifestyle.Singleton);
            container.Register<ICustomerServiceCmd, CustomerServiceCmd>(Lifestyle.Scoped);
            container.Register<ICustomerServiceQry, CustomerServiceQry>(Lifestyle.Scoped);
